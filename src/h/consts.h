...
enum Tile {
    ...
    TILE_PU_JUMP, TILE_PU_HEALTH, TILE_PU_AMMO, TILE_PU_BEER, TILE_PU_BOMB,
...
enum LayerEnum { LAYER_BG, LAYER_FG, LAYER_TERRAIN1, LAYER_TERRAIN2, LAYER_TEXT,
                 LAYER_ENEMY, LAYER_UNDERLAY, LAYER_HERO, LAYER_OVERLAY, LAYER_HUD, LAYER_HUD2 };
...
enum TextureEnum {
    ...
    TEX_PWRUP_INFJUMP, TEX_PWRUP_INFHEALTH, TEX_PWRUP_AMMO, TEX_PWRUP_BEER, TEX_PWRUP_BOMB,
    ...
    TEX_HEALTHBAR, TEX_HEALTHBAROVERLAY1, TEX_HEALTHBAROVERLAY2,
    TEX_AMMOBAR, TEX_VICTORY, TEX_PROJECTILE, TEX_PARTICLE,
    TEX_PWRUP_INFJUMP_OVERLAY, TEX_PWRUP_INFHEALTH_OVERLAY,
    TEX_PWRUP_AMMO_OVERLAY, TEX_PWRUP_BEER_OVERLAY,
    TEX_TREE1, TEX_TREE2, TEX_BENCH, TEX_BOUNCE, TEX_BOMB,
