...
#define SHADOW_SEP 10       // separation between text and shadow

/* demo.C
 * Intro Video Game Design Assignment 1
 * Andrew Zhu azhu8@jhu.edu
 * SDL code based on example written by Peter Froehlich.
 * C++ port written by Matthew Kosarek.
 */
...
enum Direction { NORTHEAST, NORTHWEST, SOUTHEAST, SOUTHWEST };
